...
const Alert = (props: AlertProps) => {
  ...
  const iconClasses = ['inline-block', 'fill-current', 'flex-shrink-0', 'select-none'];
  ...
  return (
    <div className={`fade-in flex rounded px-4 py-2 m-2 text-center ${alertColor[type]} ${fadeClass}`}>
      ...
      <div className="px-0 py-2 text-lg text-black">
        {message}
      </div>
      <div className={`${alertFg[type]} flex cursor-pointer text-2xl opacity-90 p-2 ml-auto`} onClick={onClose}>
